...
public class MultiFieldMultiViewTest extends BaseTest {
    ...
    public void testMultiFieldMultiView(TasmoMaterializerHarness t) throws Exception {
        ...
        t.readView(tenantId, actorId, new ObjectId(contentView1, contentId.getId()), Id.NULL);
        t.readView(tenantId, actorId, new ObjectId(contentView2, contentId.getId()), Id.NULL);
        t.assertExpectation(tenantIdAndCentricId);
        t.clearExpectations();
        ObjectNode view1 = t.readView(tenantId, actorId, new ObjectId(contentView1, contentId.getId()), Id.NULL);
        String deserializationInput1 = mapper.writeValueAsString(view1);
        System.out.println("Input1:" + deserializationInput1);
        ObjectNode view2 = t.readView(tenantId, actorId, new ObjectId(contentView2, contentId.getId()), Id.NULL);
