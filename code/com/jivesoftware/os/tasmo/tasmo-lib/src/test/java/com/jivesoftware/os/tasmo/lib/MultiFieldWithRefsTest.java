...
public class MultiFieldWithRefsTest extends BaseTest {
    ...
    public void testMultiFieldWithRefs(TasmoMaterializerHarness t) throws Exception {
        Views views = TasmoModelFactory.modelToViews(ContentView + "::" + originalAuthor + "::Content.ref_originalAuthor.ref.User|User.firstName,lastName,userName,ref_address");
        t.initModel(views);
