...
/**
 * Defines constants for fields names which are used by the system both in events and in tasmo view output. They cannot be used when declaring events or when
 * declaring view entries.
 */
public class ReservedFields {
    ...
    /**
     * This is the field containing the id of the user/actor generating an event this typically this is the same as userId. However in cases where someone else
     * is doing something on behalf of a given userId the actorId will be different.
     */
    ...
    /**
     * This is the field containing trace data, used as a correlation ID.
     */
    public static final String TRACE = "trace";

    /**
     * This is field containing the snowflake portion of the object id of an object being modified by an event
     */
    ...
    /**
     * This is an optional field for the view json which holds the name of a ref field in the view which should be marked as the root id of the view.
     */
    ...
    /**
     * This is the system wide field name used for deleting anything via an event write. It is implicitly bound to at the top level of any view, so that we can
     * hide views of things which have been deleted.
     */
